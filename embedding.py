...
SIGNAL_MAP = {
    ...
    "peasant":          ["tilling", "field", "cottage", "village"],
    "peasants":         ["peasant", "crowd", "village", "field"],
    "farmer":           ["peasant", "tilling", "field", "harvesting"],
    "farmers":          ["peasant", "tilling", "field", "crowd"],
    "monk":             ["church", "praying", "interior", "candle"],
    "monks":            ["monk", "church", "praying", "crowd"],
    "priest":           ["church", "praying", "interior"],
    "priests":          ["priest", "church", "crowd"],
    "nun":              ["church", "praying", "interior"],
    "nuns":             ["nun", "church", "crowd"],
    "knight":           ["armor", "sword", "horse-riding", "castle"],
    "knights":          ["knight", "armor", "sword", "crowd"],
    "squire":           ["knight", "sword-training", "castle"],
    "king":             ["castle", "crown", "throne-room"],
    "nobleman":         ["noble-man", "castle", "banquet"],
    "noblewoman":       ["noble-woman", "castle", "banquet"],
    "noble":            ["noble-man", "castle"],
    "nobles":           ["noble-man", "crowd", "banquet"],
    "guard":            ["spear", "castle", "wall", "standing"],
    "guards":           ["guard", "spear", "castle", "wall"],
    "soldier":          ["army", "armor", "fighting", "battlefield"],
    "soldiers":         ["army", "armor", "fighting", "crowd"],
    "army":             ["marching", "battlefield", "fighting", "military-camp"],
    "mercenary":        ["sword", "fighting", "military-camp"],
    "mercenaries":      ["mercenary", "sword", "fighting", "crowd"],
    "archer":           ["bow", "arrow", "hunting", "forest"],
    "archers":          ["archer", "bow", "arrow", "crowd"],
    "merchant":         ["trading", "coins", "market"],
    "merchants":        ["merchant", "trading", "market", "crowd"],
    "trader":           ["merchant", "trading", "market", "coins"],
    "traders":          ["merchant", "trading", "market", "crowd"],
    "blacksmith":       ["smithing", "anvil", "hammer", "workshop", "fire"],
    "innkeeper":        ["tavern", "drinking", "interior"],
    "miller":           ["mill", "grain", "water-wheel"],
    "lumberjack":       ["axe", "forest", "chopping", "firewood"],
    "carpenter":        ["building", "saw", "hammer", "construction-site"],
    "carpenters":       ["building", "saw", "hammer", "crowd"],
    "alchemist":        ["potion", "herbs", "workshop"],
    "scribe":           ["writing", "scroll", "book", "interior"],
    "scribes":          ["writing", "scroll", "book", "crowd"],
    "baker":            ["baking-oven", "bread", "dough", "kitchen"],
    "beggar":           ["begging", "road", "village"],
    "beggars":          ["beggar", "begging", "crowd"],
    "thief":            ["prison", "arresting", "dungeon"],
    "thieves":          ["thief", "prison", "crowd"],
    "jester":           ["partying", "banquet", "crowd"],
    "musician":         ["partying", "banquet", "tavern"],
    "musicians":        ["musician", "partying", "crowd"],
    "sailor":           ["ship", "river", "lake"],
    "sailors":          ["sailor", "ship", "crowd"],
    "plague-doctor":    ["treating-patient", "ill", "dead"],
    "doctor":           ["treating-patient", "herbs", "bed"],
    "healer":           ["treating-patient", "herbs", "potion"],
    "child":            ["kids-playing", "village", "yard"],
    "children":         ["child", "kids-playing", "crowd"],
    "family":           ["cottage", "interior", "village"],
    "crowd":            ["market", "village", "city"],
    "people":           ["crowd", "village", "market"],
    "woman":            ["family", "cottage"],
    "women":            ["family", "crowd"],
    "men":              ["crowd"],

    "bakers":           ["baker", "baking-oven", "bread", "crowd"],
    "blacksmiths":      ["blacksmith", "smithing", "anvil", "crowd"],
    "innkeepers":       ["innkeeper", "tavern", "drinking", "crowd"],
    "millers":          ["miller", "mill", "grain", "crowd"],
    "lumberjacks":      ["lumberjack", "axe", "forest", "crowd"],
    "alchemists":       ["alchemist", "potion", "herbs", "crowd"],
    "doctors":          ["doctor", "treating-patient", "herbs", "crowd"],
    "healers":          ["healer", "treating-patient", "herbs", "crowd"],
    "jesters":          ["jester", "partying", "banquet", "crowd"],
    "squires":          ["squire", "knight", "sword-training", "crowd"],
    "kings":            ["king", "castle", "crown", "crowd"],
    "cooks":            ["cook", "cooking", "kitchen", "crowd"],
    ...
    "walk":             ["walking", "road"],
    "walking":          ["road", "village", "journey"],
    "run":              ["running", "road"],
    "running":          ["road", "battlefield"],
    "sit":              ["sitting", "interior"],
    "sitting":          ["interior", "tavern"],
    "stand":            ["standing", "guard"],
    "standing":         ["guard", "wall"],
    "sleep":            ["sleeping", "bed", "interior"],
    "sleeping":         ["bed", "interior", "cottage"],
    "carry":            ["carrying", "field", "market"],
    "carrying":         ["field", "market", "road"],
    "carried":          ["carrying", "field"],
